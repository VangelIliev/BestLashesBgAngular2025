...
export class PromoPackageComponent {
  ...
  readonly promoVideoPoster = 'https://res.cloudinary.com/dl6dp2cr0/image/upload/v1761427556/NightAndDayImagePromo_lkjrad.jpg';
  readonly productImage = this.promoVideoPoster;
