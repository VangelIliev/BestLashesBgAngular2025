...
- Create Angular project with ng: `ng new bestlashesbgangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bestlashesbgangular.client.esproj`).
